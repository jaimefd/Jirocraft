...
public class IoliteOrePopulator extends BlockPopulator {
    ...
    public void populate(@NonNull WorldInfo worldInfo, @NonNull Random random, int x, int z, @NonNull LimitedRegion limitedRegion) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            oreGenerator.populateOres(1, true, y, Material.END_STONE, Material.BROWN_GLAZED_TERRACOTTA,
                    BlockFace.WEST, null, 0, Biome.SMALL_END_ISLANDS);
        }
    }
