...
public class SapphireOrePopulator extends BlockPopulator {
    ...
    public void populate(@NonNull WorldInfo worldInfo, @NonNull Random random, int x, int z, @NonNull LimitedRegion limitedRegion) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            oreGenerator.populateOres(1, true, y, Material.DEEPSLATE, Material.MAGENTA_GLAZED_TERRACOTTA,
                    BlockFace.EAST, Material.WATER, 100);
        }


        for (int i = 0; i < amount; i++) {
            int y = random.nextInt(256);
            oreGenerator.populateOres(1, true, y, Material.STONE, Material.GRAY_GLAZED_TERRACOTTA,
                    BlockFace.SOUTH, Material.WATER, 100);
        }
    }
