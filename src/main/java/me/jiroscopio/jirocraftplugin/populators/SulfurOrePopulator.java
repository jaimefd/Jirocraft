...
public class SulfurOrePopulator extends BlockPopulator {
    ...
    public void populate(@NonNull WorldInfo worldInfo, @NonNull Random random, int x, int z, @NonNull LimitedRegion limitedRegion) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            int y = random.nextInt(124) + 2;
            oreGenerator.populateOres(size, true, y, Material.NETHERRACK, Material.GREEN_GLAZED_TERRACOTTA, BlockFace.EAST, Material.AIR, 100);
        }
    }
