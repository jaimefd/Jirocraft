...
public class TitaniumOrePopulator extends BlockPopulator {
    ...
    public void populate(@NonNull WorldInfo worldInfo, @NonNull Random random, int x, int z, @NonNull LimitedRegion limitedRegion) {
        ...
        for (int i = 0; i < amount; i++) {
            ...
            oreGenerator.populateOres(1, true, y, Material.DEEPSLATE, Material.GREEN_GLAZED_TERRACOTTA, BlockFace.NORTH, Material.AIR, 100);
        }
    }
